    ...
    <div className=" bg-slate-100 dark:bg-zinc-950">
      <Container>
        ...
        >
          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 justify-items-between items-center gap-5 lg:gap-20">
            <div>
              ...
              <p className="text-slate-700 dark:text-slate-400">
                ...
                volunteers, and supporters, united by a shared vision of a
                better tomorrow.
                <br />
                Driven by empathy and a deep-seated desire to alleviate
                suffering, we have embarked on a wide range of initiatives aimed
                at addressing some of the most pressing challenges facing our
                society today. Whether it's providing essential resources to
                those in need, advocating for social justice and equality, or
                promoting environmental sustainability, we strive to tackle
                every issue with compassion, integrity, and innovation.
              </p>
            </div>
            <motion.div
              variants={aboutImage}
