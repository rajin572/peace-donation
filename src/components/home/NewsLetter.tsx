    ...
    <div className="py-20">
      <Container>
        ...
        >
          ...
          <motion.p
            className=" sm:w-[80%] md:w-[60%] text-slate-700 dark:text-slate-400"
            variants={introChildren}
          >
            Subscribe to our newsletter to stay updated on our latest
            initiatives, success stories, and upcoming events. Be the first to
            know about how your support is making a difference in the lives of
            those in need. Join our community and together, let's create
            positive change!
          </motion.p>
          <motion.div
          ...
          >
            <input
              className="w-[70%] sm:w-[500px] py-2 px-2 md:py-3 md:px-5  outline-none border border-primary dark:border-secondary shadow-md rounded-lg text-black "
              type="email"
              placeholder="Enter Your Email"
            />
            <button className="py-2 px-2 md:py-3 md:px-5 ms-[-50px] md:ms-[-110px] outline-none bg-primary dark:bg-secondary text-white dark:text-primary rounded-e-lg border border-primary dark:border-secondary">
